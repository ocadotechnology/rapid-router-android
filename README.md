...
Now you can run the app on this emulator device. Note that it won't be possible to run the AVD on certain machines, depending on the CPU specifications. If you have AMD rather than Intel drivers then you must use a physical device for testing.
